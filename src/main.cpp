...
size_t loadTriangleMesh(
    ...
    GLfloat vertices[] = {
        //triagle 0
        1.0f, 0.0f, 0.0f, //p0 v3
        0.0f, 1.0f, 0.0f, //normal
        
        0.0f, 1.0f, 0.0f, //p1 v2
        0.0f, 1.0f, 0.0f, //normal
        
        0.0f, 0.0f, 0.0f, //p2 v1
        0.0f, 1.0f, 0.0f, //normal
        
        //triagle 1
        
        0.0f, 0.0f, 1.0f, //p3 v0
        0.0f, 1.0f, 0.0f, //normal
    ...
    glEnableVertexAttribArray(0); //igual
    ...
    return 6; //numero de triangulos vezes 3
}
...
void cursor(GLFWwindow * window, double x, double y){
	MODEL = glm::translate(glm::mat4(1.0f), glm::vec3((float)(x * 0.001f), (float)(y * -0.001f), 0.0f));
}
